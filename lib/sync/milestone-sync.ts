...
export function serializeMilestones(allMilestones: Milestone[], projectId?: string): string {
  ...
  lines.push('---');
  lines.push('type: comind:milestones');
...
export async function syncMilestones(
  ...
  if (!projectId) {
    ...
    return { synced: false, type: 'comind:milestones', counts: { created: 0, updated: 0, deleted: 0 } };
  }
  ...
  return { synced: true, type: 'comind:milestones', counts };
}

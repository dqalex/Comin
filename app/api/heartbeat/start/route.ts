 ...
 * 
 * 启动所有 workspace 的 .comind-index 心跳定时器 + 文件监听器 + 定时全量同步。
...
const INIT_KEY = '__comind_heartbeat_initialized__';
const WATCHER_KEY = '__comind_watcher_initialized__';
const AUTO_SYNC_KEY = '__comind_auto_sync_initialized__';

...
export default function AgentsPage() {
  ...
  const {
    agentsList, agentsDefaultId, health, agentHealthList,
    cronJobs, skills, sessions: gwSessions,
    refreshAgents, refreshHealth, toggleCronJob, runCronJob, deleteCronJob,
    toggleSkill, installSkill, createAgent, deleteAgent,
    configForm, configLoading, configSaving, configDirty,
    loadConfig, saveConfig, reloadConfig, updateConfigForm,
  } = useGatewayStore();

...
import { useProjectStore, useMemberStore } from '@/store';
import { Search, ChevronDown, Check, Folder, Bell } from 'lucide-react';
    ...
    <header className="h-16 px-8 border-b sticky top-0 z-[5] backdrop-blur-xl" style={{ background: 'var(--glass-bg)', borderColor: 'var(--border)' }}>
      <div className="flex items-center justify-between gap-6 h-full">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <button className="relative p-2 rounded-xl transition-all duration-200 hover:bg-slate-50 dark:hover:bg-white/[0.04]" style={{ color: 'var(--text-secondary)' }}>

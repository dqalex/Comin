...
export const openclawFiles = sqliteTable('openclaw_files', {
  ...
  syncDirection: text('sync_direction'),              // to_openclaw | to_teamclaw | bidirectional
...
export const openclawVersions = sqliteTable('openclaw_versions', {
  ...
  changedBy: text('changed_by'),                    // teamclaw | openclaw | user
...
// Request
{
  ...
  direction?: 'to_teamclaw' | 'to_openclaw' | 'bidirectional';
}
